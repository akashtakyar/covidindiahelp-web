                ...
                <CardContent className="lead-container">
                  ...
                  {ite.comments.length > 0 && (
                    <>
                      ...
                      <Typography className="card-desc pt-1" variant="body2">
                        <span className="bottom-text">
                          {latestComment?.addedOn &&
                            moment(latestComment?.addedOn).fromNow()}
                        </span>{" "}
      ...
      <div className="dialog-box">
          ...
          <List>
            <ListItem
              ...
              onClick={() => {
                ...
                props.sendDownVoteRequest(
                  props.state.id,
                  "Answered but out of stock"
                );
              }}
            >
        ...
        <div>
          <input
            ...
            onChange={(e) =>
              props.onStateChange("customComment", e.target.value)
            }
          />
          <button
      ...
      <div className="dialog-box">
        ...
        <div>
          <input
            ...
            onChange={(e) =>
              props.onStateChange("workingComment", e.target.value)
            }
          />
          <button
            className="add-comment-button"
            onClick={() => {
              props.sendUpVoteRequest(
                props.state.id,
                props.state.workingComment
              );
            }}
          >
            Add Comment
        ...
        props.state.selectedItem.attachments.media_keys.length ? (
            ...
            <Row className="card-timestamp">
              <Column>
                <div className="p-t-20 p-r-20 p-b-10 bottom-text">
                  {(props.state.selectedItem?.comments?.length > 0 &&
                    props.state.selectedItem.comments.map(
                      (comment, index) =>
                    ...
                    moment(
                      props.state.selectedItem?.channelCreatedOn || ""
                    ).fromNow()}
                </div>
              </Column>
              <Column>
                <div className="p-t-20 p-r-20 p-b-10 bottom-text">
                  {`Source: ${utility.toSentenceCase(
                    props.state.selectedItem?.channel || ""
                  )}`}
                </div>
              </Column>
            </Row>
          ...
          <div className="selected-item ">
            ...
            <Row className="card-timestamp">
              ...
              {props.state.selectedItem?.comments?.length < 1 && (
                <Column>
                  <div className="p-l-20 p-t-20 p-r-20 p-b-10 bottom-text">
                    {`Source: ${utility.toSentenceCase(
                      props.state.selectedItem?.channel || ""
